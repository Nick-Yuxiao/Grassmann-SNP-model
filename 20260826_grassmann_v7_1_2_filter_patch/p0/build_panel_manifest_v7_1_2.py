...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build the frozen v7.1.2 Branch-B panel manifest")
    ...
    if spec.get("protocol_version") != "v7.1.2":
        raise SystemExit("panel spec must declare protocol_version v7.1.2")
    ...
    output = args.output_dir / "PANEL_MANIFEST.v7.1.2.json"
