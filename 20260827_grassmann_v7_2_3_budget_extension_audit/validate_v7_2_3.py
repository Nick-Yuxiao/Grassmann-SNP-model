...
REQUIRED = [
    "PROTOCOL_ADDENDUM.v7.2.3.md", "BUDGET_EXTENSION_SPEC.v7.2.3.yaml",
    "DECISIONS.v7.2.3.tsv", "BUDGET_EXTENSION_SCHEDULE.v7.2.3.tsv",
    "validate_v7_2_3.py", "p0/train_budget_extension_v7_2_3.py",
    "p0/run_budget_extension_gpu_worker_v7_2_3.py",
    "p0/assess_budget_extension_v7_2_3.py",
    "p0/run_budget_extension_v7_2_3_nonintrusive.sh",
    "p0/tests/test_v7_2_3.py", "server_ops/SERVER_STEPS.v7.2.3.md",
]
...
def main() -> None:
    ...
    checks = {
        ...
        "shape_protocol": "STABLE_BUT_ACCELERATING" in
        (ROOT / "PROTOCOL_ADDENDUM.v7.2.3.md").read_text(encoding="utf-8"),
        "control_not_negative": "not required to fail" in
        (ROOT / "PROTOCOL_ADDENDUM.v7.2.3.md").read_text(encoding="utf-8"),
    }
    ...
    print(json.dumps({
        "status": "PASS", "protocol_version": "v7.2.3",
        ...
        "shape_flag": "NON_PRIMARY_BLOCKS_AUTOMATIC_FREEZE",
