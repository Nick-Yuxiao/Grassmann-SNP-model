...
output='/mnt/f/Yuxiao Tan/Document/Grassmann_model_external/e0_runs/e1_realdata_smoke_rc0/E1_SMOKE_SUMMARY.json'

cd "$project_root"
python "$protocol_rel/scripts/run_e1_realdata_smoke.py" \
