...
| v3 Supplementary | v3 页面的 Supplementary 链接（DC1 路径中的日期会变成 `2026/01/15`） | `paper/G2PT_v3_supplementary.pdf` | 中 |
...
2. 把 v2 Supplementary 给我，我把网格点补进 `PAPER_SPEC.zh-CN.md` §9，B6 就能彻底关闭。
